...
class S3Storage(base.Storage, s3.S3Storage):  # pyright: ignore[reportIncompatibleVariableOverride]
    """AWS S3 adapter."""
    ...
    def declare_config_options(cls, declaration: Declaration, key: Key):
        ...
        declaration.declare(key.bucket).required().set_description("Name of the storage bucket.")
